...
public class AdminHomeworkAdapter extends RecyclerView.Adapter<AdminHomeworkAdapter.ViewHolder> {

    private  final String TAG = AdminHomeworkAdapter.this.getClass().getName();
    Context mContext;
    List<AdminHomeworkNode> homeworkNodeArrayList;

    public AdminHomeworkAdapter(Context mContext, List<AdminHomeworkNode> homeworkNodeArrayList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        final AdminHomeworkNode homeWorkNode = homeworkNodeArrayList.get(position);
