...
public class TeacherAssignmentAdapter extends RecyclerView.Adapter<TeacherAssignmentAdapter.ViewHolder> {
    ...
    Context mContext;
    List<TeacherAssignmentNode> assignmentNodeList;

    public TeacherAssignmentAdapter(Context mContext, List<TeacherAssignmentNode> assignmentNodeList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        TeacherAssignmentNode assignmentNode = assignmentNodeList.get(position);
