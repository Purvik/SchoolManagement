...
import com.ourwork.schoolmanagement.singleton.response.teacher.SubjectNode;
 ...
 */
public class AddAssignmentHomeworkActivity extends AppCompatActivity implements Spinner.OnItemSelectedListener {
    ...
    private List<String> sectinList, classList, subjectList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_assignment_homework);

        mContext = AddAssignmentHomeworkActivity.this;

        addItemType = getIntent().getStringExtra("addItemType");
                ...
                public void onResponse(Call<TeacherClassNodeResponseData> call, Response<TeacherClassNodeResponseData> response) {
                    ...
                    if (response.code() == AppConstant.RESPONSE_CODE_OK) {
                        ...
                        if (teacherClassNodeList.size() != 0) {
                            ...
                            classSpinner.setOnItemSelectedListener(AddAssignmentHomeworkActivity.this);
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedTeacherClassNode == null ||
                    ...
                    uploadAssignmentHomeworkRequest.setClassesID(selectedTeacherClassNode.getClassesID());
                    uploadAssignmentHomeworkRequest.setSectionID(selectedSectionListNode.getSectionID());
                    uploadAssignmentHomeworkRequest.setSubjectID(selectedSubjectNode.getSubjectID());
                    uploadAssignmentHomeworkRequest.setSchool_id(studentParentResp.getSchoolId());
                    uploadAssignmentHomeworkRequest.setUsertypeID(studentParentResp.getUsertypeID());
                    uploadAssignmentHomeworkRequest.setFile(selectedUploadFile);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 100 && resultCode == RESULT_OK && data != null) {
            ...
            if (uriString.startsWith("content://")) {
                ...
                displayName = selectedUploadFile.getName();
            }
                    ...
                    sectionListCall.enqueue(new Callback<SectionListResponseData>() {
                        ...
                        public void onResponse(Call<SectionListResponseData> call, Response<SectionListResponseData> response) {
                            ...
                            if (response.code() == AppConstant.RESPONSE_CODE_OK) {
                                ...
                                sectionListNodeList = response.body().getData().getSection();
                                ...
                                if (sectionListNodeList.size() != 0) {
                                    ...
                                    sectionSpinner.setOnItemSelectedListener(AddAssignmentHomeworkActivity.this);
                        ...
                        public void onResponse(Call<SubjectNodeResponseData> call, Response<SubjectNodeResponseData> response) {
                            ...
                            if (response.code() == AppConstant.RESPONSE_CODE_OK) {
                                ...
                                if (subjectNodeList.size() != 0) {
                                    ...
                                    subjectSpinner.setOnItemSelectedListener(AddAssignmentHomeworkActivity.this);
